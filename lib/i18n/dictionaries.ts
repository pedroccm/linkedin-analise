...
export const dictionaries = {
  pt: {
    ...
    account: {
      ...
      whatsapp: "WhatsApp para alertas",
      whatsappPlaceholder: "+55 11 99999-9999",
      whatsappHint: "Receba um aviso no WhatsApp quando um perfil monitorado publicar.",
      save: "Salvar",
      saving: "Salvando…",
      plan: "Plano",
      manageBilling: "Gerenciar plano e pagamento",
      logout: "Sair",
      orgTitle: "Organização",
      orgCreate: "Criar organização",
      orgNamePlaceholder: "Nome da organização",
      orgMembers: "Membros",
      orgInvite: "Convidar por email",
      orgInvitePlaceholder: "email@empresa.com",
      orgInviteBtn: "Convidar",
      orgPending: "Convites pendentes",
      orgInviteLink: "Link do convite",
      orgRevoke: "Revogar",
      orgRemove: "Remover",
      orgOwner: "dono",
    ...
    billing: {
      ...
      corporateDesc: "Para times: workspace compartilhado + convidar membros",
      corporateFeatures: [
        "Até 100 perfis do LinkedIn",
        "Convide seu time — perfis, tags e feed compartilhados",
        "Sincronizações ilimitadas",
        "Suporte prioritário",
      ],
    },
    ...
    profile: {
      ...
      monitorOffHint: "Receber alerta no WhatsApp quando publicar",
      monitorOnHint: "Monitoramento ativo · clique para parar",
  ...
  en: {
    ...
    account: {
      ...
      whatsapp: "WhatsApp for alerts",
      whatsappPlaceholder: "+55 11 99999-9999",
      whatsappHint: "Get a WhatsApp alert when a monitored profile publishes.",
      save: "Save",
      saving: "Saving…",
      plan: "Plan",
      ...
      orgMembers: "Members",
      orgInvite: "Invite by email",
      orgInvitePlaceholder: "email@company.com",
      orgInviteBtn: "Invite",
      orgPending: "Pending invites",
      orgInviteLink: "Invite link",
      orgRevoke: "Revoke",
      orgRemove: "Remove",
      orgOwner: "owner",
    ...
    billing: {
      ...
      corporateDesc: "For teams: shared workspace + invite members",
      corporateFeatures: [
    ...
    profile: {
      ...
      monitorOffHint: "Get a WhatsApp alert when this profile publishes",
      monitorOnHint: "Monitoring on · click to stop",
